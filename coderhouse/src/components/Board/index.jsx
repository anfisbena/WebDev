  ...
  return(
    <Box sx={{ flexGrow: 1 }}>
      <Grid container disableEqualOverflow>
        <Grid xl={4} lg={4} md={4} sm={10} xs={11} display="flex" justifyContent="center" alignItems="center">
          <MenuCard
            image={"https://temptationcakes.co.nz/wp-content/uploads/2015/11/030.jpg"} 
            category={'Pasteles'}/>
        </Grid>
        <Grid item xl={4} lg={4} md={4} sm={10} xs={11} display="flex" justifyContent="center" alignItems="center">
          <MenuCard 
